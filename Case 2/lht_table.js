...
var thisDay = new Date("August 30 2018");//august 30 2018

/* Write the HTML code for the event list table */
var tableHTML = "<table id=eventTable>"; //eventTable??
...
var endDate = new Date(thisDay.getTime() + 14*24*60*60*1000);//getTime?
...
for (var i = 0; i < eventDates.length; i++) {
   ...
   if (thisDay <= eventDate && thisDay <= endDate) {//what else are we looking for
      tableHTML += "<tr>";
